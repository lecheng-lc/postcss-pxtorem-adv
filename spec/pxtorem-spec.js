...
describe('pxtorem', function () {
  ...
  it('should keep px', function () {
    var input = 'h1 { margin: 0 0 20px; font-size: 32px; line-height: 1.2; letter-spacing: 1px; }'
    var output = 'h1 { margin: 0 0 20px; font-size: 16px; line-height: 1.2; letter-spacing: 0.5px; }'
    var processed = postcss(pxtorem({ unit: 'px', rootValue: 32 })).process(input).css

    expect(processed).toBe(output)
  })

  it('should convert rpx to rem', function () {
    var input = 'h1 { margin: 0 0 16rpx; font-size: 32rpx; line-height: 1.2; letter-spacing: 16px; }'
    var output = 'h1 { margin: 0 0 0.5rem; font-size: 1rem; line-height: 1.2; letter-spacing: 8px; }'
    var processed = postcss(pxtorem({ unit: 'px', rootValue: 32 })).process(input).css
